...
void setup() {
  ...
  PImage friends = loadImage("coolkid.jpg");  // 2. Change this to match the name of your photo. 
  ...
  mustache = loadImage("stache.png"); // 5. Change this to match your file name.
  background(friends);
}
